...
define( 'KOHAKU_VERSION', '1.0.0' );

if ( ! function_exists( 'kohaku_setup' ) ) {
	add_action( 'after_setup_theme', 'kohaku_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function kohaku_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'kohaku' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'kohaku' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in kohaku_smart_content_width()
		 */
...
define('KOHAKU_THEME_URL','https://wpkoi.com/kohaku-wpkoi-wordpress-theme/','kohaku');
define('KOHAKU_WPKOI_AUTHOR_URL','https://wpkoi.com/','kohaku');
define('KOHAKU_DOCUMENTATION','https://wpkoi.com/docs/','kohaku');