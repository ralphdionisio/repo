...
if ( ! function_exists( 'kohaku_archive_title' ) ) {
	add_action( 'kohaku_archive_title', 'kohaku_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function kohaku_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * kohaku_before_archive_title hook.
			 *
			 */
			do_action( 'kohaku_before_archive_title' );
			?>
			...
			<?php
			/**
			 * kohaku_after_archive_title hook.
			 *
			 */
			do_action( 'kohaku_after_archive_title' );
			...
			/**
			 * kohaku_after_archive_description hook.
			 *
			 */
			do_action( 'kohaku_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'kohaku_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'kohaku_filter_the_archive_title' );
	/**
	 ...
	 */
	function kohaku_filter_the_archive_title( $title ) {
		if ( is_category() ) {
